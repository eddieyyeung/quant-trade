...
Session persistence: simulator session metadata stored in a DuckDB simulator_session table and decision logs persisted on disk, with save/load/list/delete lifecycle operations.
