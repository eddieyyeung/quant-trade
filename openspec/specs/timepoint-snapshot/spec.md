...
Timepoint snapshot: aggregate market overview, portfolio state, factor rankings, and strategy signals at a cursor date, computed using only data available at or before that date.
